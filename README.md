...
**Analytic model:** To illustrate how DEQNs can be applied to solve economic models, we provide an example in python, which solves the model presented in [Appendix C](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3393482) of the paper.
...
**Benchmark model:** Additionally, we provide the code used to solve our [benchmark model (section 3)](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3393482) with the trained neural network weights.

## Usage
We provide implementations which use python 3 and which were programmed in TensorFlow 1.
...
The benchmark model code is was also written in TensorFlow 1, however, as been made TensorFlow 2 compatible.
